...
let ProjectConfigurationController = {
    ...
    async getOne(ctx) {
        ...
        try {
            ...
            let targetItem = await ctx.service.projectConfiguration.item({
                query: {
                    id: id
                }
            });
    ...
    async update(ctx, app) {
        ...
        try {
            ...
            await ctx.service.projectConfiguration.update(fields.id, modelObj);
    ...
    async removes(ctx) {
        ...
        try {
            ...
            await ctx.service.projectConfiguration.removes(targetIds);
            ctx.helper.renderSuccess(ctx);
    ...
    async doRender(ctx, app) {
        ...
        try {
            ...
            let eggPluginKey = `egg-doras-${targetKey.toLowerCase()}`; // 首字母大写
            ...
            let egg_plugin_source_path = `${assetsPath}/egg-doras-demo`;
            ...
            fs.renameSync(`${egg_plugin_target_source_path}/egg-doras-demo`, `${egg_plugin_target_source_path}/${eggPluginKey}`);
